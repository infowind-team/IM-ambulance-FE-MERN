    ...
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="ghost"
            className="justify-start text-center text-[#2160AD] text-base font-normal h-9 px-4 flex gap-2 hover:bg-[#2160AD]/10!"
          >
            <CalendarIcon className="h-4 w-4 text-[#2160AD]" />
            {formatDisplay()}
          </Button>
        </PopoverTrigger>

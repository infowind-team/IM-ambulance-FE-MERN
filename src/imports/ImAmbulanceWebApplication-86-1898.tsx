import svgPaths from "./svg-rzt0qo005e";
  ...
  return (
    <div className="relative shrink-0 size-[26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="Icon">
          <path d="M8.66602 2.1665V6.49984" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
          <path d="M17.334 2.1665V6.49984" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="Icon">
          <path d={svgPaths.pff8c300} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="Icon">
          <path d={svgPaths.p38a34d20} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p185ca980} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[58.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] overflow-clip relative rounded-[inherit] w-[58.922px]">
        <p className="absolute font-['Lato:Medium',sans-serif] leading-[24px] left-0 not-italic text-[16px] text-nowrap text-white top-0 whitespace-pre">Services</p>
      </div>
    </div>
  );
}
...
function Icon10() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p20ac2b00} id="Vector" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function BreadcrumbLink1() {
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="BreadcrumbLink">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-full">
        <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-0 whitespace-pre">Services</p>
      </div>
    </div>
  );
}
...
function PageHeader1() {
  return (
    <div className="absolute content-stretch flex gap-[4px] h-[20px] items-center left-[110.11px] top-0 w-[69.563px]" data-name="PageHeader">
      <BreadcrumbItem1 />
...
function BreadcrumbLink2() {
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="BreadcrumbLink">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-full">
        <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-0 whitespace-pre">Add New Contract</p>
      </div>
    </div>
  );
}
...
function BreadcrumbItem2() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-center left-[189.67px] top-0 w-[115.531px]" data-name="BreadcrumbItem">
      <BreadcrumbLink2 />
    </div>
  );
}
...
function BreadcrumbList() {
  return (
    <div className="h-[20px] relative shrink-0 w-[305.203px]" data-name="BreadcrumbList">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[305.203px]">
        <PageHeader />
        <PageHeader1 />
        <BreadcrumbItem2 />
      </div>
...
function Heading1() {
  return (
    <div className="h-[26px] relative shrink-0 w-[305.203px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[26px] relative w-[305.203px]">
        <p className="absolute font-['Lato:Medium',sans-serif] leading-[26px] left-0 not-italic text-[#2160ad] text-[26px] text-nowrap top-0 whitespace-pre">Add New Contract</p>
      </div>
    </div>
  );
}
...
function PageHeader2() {
  return (
    <div className="absolute bg-[rgba(33,96,173,0.05)] content-stretch flex flex-col gap-[8px] h-[54px] items-start justify-end left-[24px] top-[16px] w-[305.203px]" data-name="PageHeader">
      <BreadcrumbList />
      <Heading1 />
    </div>
  );
...
function Container93() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[3184px] items-start left-0 overflow-clip pl-0 pr-[15px] py-0 top-[86px] w-[2844px]" data-name="Container">
...
function ServiceManagement() {
  return (
    <div className="basis-0 grow h-[2856px] min-h-px min-w-px relative shrink-0" data-name="ServiceManagement">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[2856px] overflow-clip relative rounded-[inherit] w-full">
        <PageHeader2 />
        <Container93 />
      </div>
    </div>

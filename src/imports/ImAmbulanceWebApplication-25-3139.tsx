import svgPaths from "./svg-7hvzjlb386";
...
function BreadcrumbList() {
  return (
    <div className="h-[20px] relative shrink-0 w-[214.5px]" data-name="BreadcrumbList">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[214.5px]">
        <PageHeader />
        <BreadcrumbItem1 />
      </div>
    </div>
...
function Heading1() {
  return (
    <div className="h-[26px] relative shrink-0 w-[214.5px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[26px] relative w-[214.5px]">
...
function PageHeader1() {
  return (
    <div className="bg-[rgba(33,96,173,0.05)] h-[86px] relative shrink-0 w-[2844px]" data-name="PageHeader">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[86px] items-start pb-0 pl-[24px] pr-[2605.5px] pt-[16px] relative w-[2844px]">
        <Container22 />
      </div>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-[85.484px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[85.484px]">
        <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#717182] text-[14px] text-nowrap top-0 whitespace-pre">{`Today's Cases`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d="M16 8V16L21.3333 18.6667" id="Vector" stroke="var(--stroke-0, #2160AD)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
          <path d={svgPaths.p21f38a00} id="Vector_2" stroke="var(--stroke-0, #2160AD)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function CaseManagement() {
  return (
    <div className="h-[32px] relative shrink-0 w-[653px]" data-name="CaseManagement">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[32px] items-center justify-between relative w-[653px]">
        <Paragraph />
        <Icon12 />
      </div>
    </div>
...
function Paragraph1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[68.297px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[68.297px]">
        <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#717182] text-[14px] text-nowrap top-0 whitespace-pre">Completed</p>
      </div>
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p626a600} id="Vector" stroke="var(--stroke-0, #00A63E)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
          <path d={svgPaths.p31991ba0} id="Vector_2" stroke="var(--stroke-0, #00A63E)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[69.109px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[69.109px]">
        <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#717182] text-[14px] text-nowrap top-0 whitespace-pre">In Progress</p>
      </div>
    </div>
  );
}
...
function Icon14() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p1c84c300} id="Vector" stroke="var(--stroke-0, #F54900)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
          <path d={svgPaths.p16150d00} id="Vector_2" stroke="var(--stroke-0, #F54900)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Lato:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#717182] text-[14px] text-nowrap top-0 whitespace-pre">Critical Cases</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Lato:SemiBold',sans-serif] leading-[32px] left-0 not-italic text-[#e7000b] text-[24px] text-nowrap top-0 whitespace-pre">5</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="h-[52px] relative shrink-0 w-[83.922px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[52px] items-start relative w-[83.922px]">
        <Paragraph3 />
        <Paragraph4 />
      </div>
    </div>
...
function Icon15() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p3f416300} id="Vector" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
          <path d={svgPaths.p266fe00} id="Vector_2" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.6" strokeWidth="2.66667" />
        </g>
      </svg>
    </div>
  );
...
function CaseManagement3() {
  return (
    <div className="h-[52px] relative shrink-0 w-[653px]" data-name="CaseManagement">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[52px] items-center justify-between relative w-[653px]">
        <Container23 />
        <Icon15 />
      </div>
    </div>
...
function Container24() {
  return (
    <div className="absolute gap-[16px] grid grid-cols-[repeat(4,_minmax(0px,_1fr))] grid-rows-[repeat(1,_minmax(0px,_1fr))] h-[94px] left-[24px] top-[24px] w-[2796px]" data-name="Container">
      <Card />
      <Card1 />
      <Card2 />
      <Card3 />
...
function Container27() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-center justify-between left-[24px] top-[142px] w-[2796px]" data-name="Container">
      <Container26 />
      <Button1 />
    </div>
  );
...
function Card4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col h-[179px] items-start left-[24px] p-px rounded-[14px] top-[202px] w-[2796px]" data-name="Card">
...
function Text13() {
  return (
    <div className="absolute h-[24px] left-[24px] top-[405px] w-[148.109px]" data-name="Text">
      <p className="absolute font-['Lato:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#717182] text-[16px] top-0 w-[149px]">Showing 1 of 1 cases</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[2844px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-full items-start overflow-clip relative rounded-[inherit] w-[2844px]">
        <Container34 />
      </div>
    </div>
  );
...
function CaseManagement16() {
  return (
    <div className="basis-0 bg-white grow h-[1353px] min-h-px min-w-px relative shrink-0" data-name="CaseManagement">
